...
<b><u>ɢɪᴛʜᴜʙ :</b></u>
 ...
 ⦿ /git <ᴜsᴇʀɴᴀᴍᴇ> ➠ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ɢɪᴛʜᴜʙ ᴜsᴇʀ.
...
<b><u>Wᴇʟᴄᴏᴍᴇ :</b></u>
 ...
 ⦿ /wel ᴏɴ/ᴏғғ ➠ sᴘᴇᴄɪᴀʟ ᴡᴇʟᴄᴏᴍᴇ ᴏɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ
"""
HELP_23 = """
<b><u>Sᴇᴀʀᴄʜ :</b></u>

Available commands:
⦿ /google <query> : ꜱᴇᴀʀᴄʜ ᴛʜᴇ ɢᴏᴏɢʟᴇ ꜰᴏʀ ᴛʜᴇ ɢɪᴠᴇɴ ǫᴜᴇʀʏ.
⦿ /anime <query>  : ꜱᴇᴀʀᴄʜ ᴍʏᴀɴɪᴍᴇʟɪꜱᴛ ꜰᴏʀ ᴛʜᴇ ɢɪᴠᴇɴ ǫᴜᴇʀʏ.
⦿ /stack <query>  : ꜱᴇᴀʀᴄʜ ꜱᴛᴀᴄᴋᴏᴠᴇʀꜰʟᴏᴡ ꜰᴏʀ ᴛʜᴇ ɢɪᴠᴇɴ ǫᴜᴇʀʏ.
⦿ /image (/imgs) <query> : ɢᴇᴛ ᴛʜᴇ ɪᴍᴀɢᴇꜱ ʀᴇɢᴀʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ǫᴜᴇʀʏ.
...
⦿ /imposter ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ ➠ ᴛᴜʀɴs ᴏɴ ᴏʀ ᴏғғ ᴛʜᴇ ᴡᴀᴛᴄʜᴇʀ ғᴏʀ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴡʜɪᴄʜ ɴᴏᴛɪғɪᴇs ᴀʙᴏᴜᴛ ᴜsᴇʀs ᴡʜᴏ ᴄʜᴀɴɢᴇ ᴛʜᴇɪʀ ɴᴀᴍᴇ ᴏʀ ᴜsᴇʀɴᴀᴍᴇ.
"""

HELP_25 = """
<b><u>sᴏᴜʀᴄᴇ-ᴄᴏᴅᴇ :</b></u>

⦿ /repo ➠ ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ.
"""
